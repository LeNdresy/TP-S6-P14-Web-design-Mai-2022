...
<head>
  ...
  <!-- Favicons -->
  <link href="{{secure_url('assets/img/ia.jpg')}}" rel="icon">
  <link href="{{secure_url('assets/img/ia.jpg')}}" rel="apple-touch-icon">
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="index.html" class="logo d-flex align-items-center w-auto">
                  <img src="{{secure_url('assets/img/ia.jpg" ')}}" alt="">
                  <span class="d-none d-lg-block">Login BackOffice</span>
                </a>
              </div><!-- End Logo -->
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Identification</h5>
                    <p class="text-center small">Pseudo et Mot de passe</p>
                  </div>
                  ...
                  <form class="row g-3 needs-validation" action="login" method="POST">
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        <input type="text" name="username" class="form-control" id="yourUsername" value="Jean" required>
                      </div>
                    </div>

                    <div class="col-12">
                      <label for="yourPassword" class="form-label">Password</label>
                      <input type="password" name="password" class="form-control" id="yourPassword" value="jean" required>
                    </div>
